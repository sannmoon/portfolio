  ...
  return (
    <div className="md:flex justify-between gap-8 max-w-6xl mx-10 md:mx-auto md:w-auto">
      <div className="flex-1 border-solid	border-2 border-sky-500 max-w-2xl text-[20px] p-4 mb-4 md:mb-0">
        <p className="mb-4">
          Hello, I’m Sandar <GiCyborgFace className="inline" /> <br />
          A former accountant who made the leap into web development. In 2024, I
          decided to step away from the world of balance sheets to follow my
          true interests <GiCyberEye className="inline" /> <br />I wanted a
          career where I could build, create and solve problems, so I dedicated
          myself to learning code and developing my own projects.
        </p>
        <p className="mb-4">
        ...
        <p>
          ...
          <IoLogoReact className="inline" />.<br /> As I delved deeper into
